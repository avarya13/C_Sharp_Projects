    ...
    class DB
    {
        ...
        public static void Menu(ref Student[] students)
        {
            ...
            while (c == true)
            {
                ...
                {
                    case "да":
                        Console.WriteLine("Выберите: поиск по ФИО, поиск по дате, удалить, запись, мин/макс балл или сортировка ");
                        string z = Console.ReadLine();
                        while (z != "поиск по ФИО" && z != "поиск по дате" && z != "мин/макс балл" && z != "удалить" && z != "удалить повтор" && z != "сортировка" && z != "запись")
                        {
